...
{ 
	...
	{ 
		...
		//driver.scrollTo("Tab 11"); Not working
		...
		for(int i=0; i<=10; i++){
			...
			{
				//If Tab 11 Is not displayed then scroll tabs from right to left direction by calling 
				//ScrollTabs() method. 
				ScrollTabs(); 
				}
			} 
		...
		WebElement ele2 = driver.findElement(By.className("android.widget.TextView"));
