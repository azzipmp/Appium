...
public class performOrientation { 
	static AndroidDriver driver; 
	@BeforeTest
	public void setUp() throws Exception { 
		// Start appium server. appiumStart();
...
@Test 
public void performscreenOrientation() throws InterruptedException 
{
...
{
	driver.quit(); // Stop appium server when test Is ended. appiumStop(); } } 
}
}